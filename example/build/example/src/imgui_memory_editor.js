...
export class MemoryEditor {
    ...
    ReadFn; // = 0 // optional handler to read bytes.
    WriteFn; // = 0 // optional handler to write bytes.
    HighlightFn; // = 0 // optional handler to return Highlight property (to support non-contiguous highlighting).
    // [Internal State]
    ContentsWidthChanged;
    DataPreviewAddr;
    DataEditingAddr;
    DataEditingTakeFocus;
    DataInputBuf = new ImGui.StringBuffer(32); /*char[32]*/
    ;
    AddrInputBuf = new ImGui.StringBuffer(32); /*char[32]*/
    ;
    GotoAddr;
    HighlightMin;
    HighlightMax;
            ...
            for (let /*int*/ n = 0; n < this.Cols && addr < mem_size; n++, addr++) {
                ...
                if (this.DataEditingAddr === addr) {
                    ...
                    class UserData {
                        ...
                        CurrentBufOverwrite = new ImGui.StringBuffer(3); // Input
                        CursorPos = 0; // Output
                    }
