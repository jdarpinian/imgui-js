...
export class ImGuiIO
{
    ...
    public AddMouseWheelEvent(wh_x: number, wh_y: number): void { this.native.AddMouseWheelEvent(wh_x, wh_y); }
    ...
    public AddMouseViewportEvent(id: ImGuiID): void { this.native.AddMouseViewportEvent(id); }
