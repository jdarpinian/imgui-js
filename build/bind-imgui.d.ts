...
export interface reference_ImGuiViewport extends Emscripten.EmscriptenClassReference {
    ...
    readonly Pos: reference_ImVec2;
    // ImVec2              Size;                   // Main Area: Size of the viewport.
    readonly Size: reference_ImVec2;

    // ImVec2              WorkPos;                // Work Area: Position of the viewport minus task bars, menus bars, status bars (>= Pos)
    readonly WorkPos: reference_ImVec2;
    // ImVec2              WorkSize;               // Work Area: Size of the viewport minus task bars, menu bars, status bars (<= Size)
    readonly WorkSize: reference_ImVec2;
...
export interface Module extends Emscripten.EmscriptenModule {
    ...
    SetNextWindowScroll(size : Readonly<interface_ImVec2>): void;
}
